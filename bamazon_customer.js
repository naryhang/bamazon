...
//Inquirer intro (prompt and then)
...
function startPrompt() {
    ...
    inquirer.prompt([{
        ...
        type: "confirm",
        name: "confirm",
        message: "Welcome to Bamazon! Would you like to view our Legos inventory?",
        default: true
...
function inventory() {
    ...
    function listInventory() {
        ...
        connection.query("SELECT * FROM products", function(err, res) {
            ...
            console.log("");
            console.log("====================================================== Current Bamazon Legos Inventory ======================================================");
            console.log("");
